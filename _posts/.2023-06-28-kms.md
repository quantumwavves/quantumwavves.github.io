...
description: Que es un servicio de Key Management Service y como poder implementarlo de manera local.
author: Quantum 
date: 2023-06-28
categories: [Deploys]
tags: [key management service,ciberseguridad,docker]
image:
  path: /assets/img/posts/guias/kms_guide/header.png
  alt: TBD.
---
...
![Desktop View](/assets/img/posts/guias/kms_guide/network-kms-example.jpg)
...
![Desktop View](/assets/img/posts/guias/kms_guide/nijika-icon.jpg){: w="400" h="200" }
...
![Desktop View](/assets/img/posts/guias/kms_guide/nijika-menu.png){: w="500" h="200" }

Una vez completado el paso a elegir se mostrará el siguiente mensaje:

Para activar la licencia:

![Desktop View](/assets/img/posts/guias/kms_guide/nijika-op1-2.png){: w="500" h="200" }

Para eliminar la licencia:

![Desktop View](/assets/img/posts/guias/kms_guide/nijika-op3.png){: w="500" h="200" }
...
![Desktop View](/assets/img/posts/guias/kms_guide/tcp-diagram.jpg){: h='900' w='400' }
...
![Desktop View](/assets/img/posts/guias/kms_guide/nmap-kms-server.png){: w="600" h="400"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/tracert-kms.png){: w="600" h="400" }

Realizaremos un escaneo a los puertos del servidor final con nmap.

![Desktop View](/assets/img/posts/guias/kms_guide/nmap-kms-instance1.png){: w="600" h="400" }
...
![Desktop View](/assets/img/posts/guias/kms_guide/traceroute-kms.png){: w="800" h="600"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/nslookup-kms.png){: w="600" h="400"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/nmap-kms-instance2.png){: w="600" h="400"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/kms-client.png){: w="600" h="400"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/tcp-client.png){: w="800" h="600"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/udp-client.png){: w="800" h="600"}

Ahora realizaremos una enumeracion al servicio SMB

![Desktop View](/assets/img/posts/guias/kms_guide/smb-enum.png){: w="800" h="600"}
...
![Desktop View](/assets/img/posts/guias/kms_guide/kms-anyrun.png){: w="800" h="600"}

Ahora analizaremos el tráfico HTTP y HTTPS en el tiempo de la activación.

 <video width="700" height="500" controls>
  <source src="/assets/img/posts/guias/kms_guide/TCP-Services.mp4" type="video/mp4">
</video> 
...
![malwarebytes](/assets/img/posts/guias/kms_guide/kms-malwarebytes.jpg) 
...
![cuota](/assets/img/posts/guias/kms_guide/cuota.png) 
...
![Desktop View](/img/in-post/kms_guide/kita.gif)
...
![Desktop View](/img/in-post/kms_guide/kita-menu.png){: w="400" h="200" }

Para nuestra primera opción podemos seleccionar la versión a instalar

![Desktop View](/img/in-post/kms_guide/kita-op-1.png){: w="400" h="200" }

De igual manera podemos seleccionar el bloat (peso) de las aplicaciones que queramos:

![Desktop View](/img/in-post/kms_guide/kita-op-1-bloat.png){: w="800" h="600" }

Una vez completada la instalación, nos preguntara si queremos activar office: 

![Desktop View](/img/in-post/kms_guide/kita-act-ask.png){: w="400" h="200" }

Nos mandara a la segunda opcion del menu: 

![Desktop View](/img/in-post/kms_guide/kita-op-2.png){: w="400" h="200" }

Cuando la activación muestra la salida. 

![Desktop View](/img/in-post/kms_guide/kita-act-com.png){: w="600" h="400" }

Para la elección 3, nos mostrará la siente salida:

![Desktop View](/img/in-post/kms_guide/kita-op-3.png){: w="600" h="400" }
